...
function updatePositions() {
  ...
  var scrollConst = Math.sin((document.body.scrollTop / 1250));
  /*var phaseArray = [scrollConst,scrollConst+1,scrollConst+2,scrollConst+3,scrollConst+4];
  for (var i = 0; i < items.length; i++) {
   // var phase = Math.sin((document.body.scrollTop / 1250) + (i % 5));
    items[i].style.transform = 'translateX('+items[i].basicLeft + 100 * phaseArray[i] + 'px)';
  }*/
